...
interface PassengerListInfoProps {
  userType: "aluno" | "servidor" | "motorista";
  vagasTotais: number;
  inscritosAlunos: number;
  inscritosServidores: number;
  totalInscritos: number;
}

export function PassengerListInfo({ userType, vagasTotais, inscritosAlunos, inscritosServidores,  totalInscritos}: PassengerListInfoProps) {
    ...
    return (
      <div className="bg-[#f0f4f8] rounded-xl p-3 mb-4">
        <div className="flex items-center justify-between mb-2">
          ...
          <span className="text-[11px] font-extrabold text-[#103173]">{inscritosServidores}/{vagasTotais}</span>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-semibold text-[#103173]/70">{inscritosServidores} Servidores</span>
        </div>
      </div>
    );
  }
