...
export function AdminRelatoriosTabs({
  ...
  return (
    <div className="space-y-12">
      ...
      {/* SEÇÃO 2: Auditoria de Seguro */}
      <section className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-500 pt-8 border-t border-slate-200">
        <div>
          <h2 className="text-xl font-bold text-[#103173]">Auditoria de Seguro (Lista Nominal)</h2>
          <p className="text-sm text-slate-500 mt-1">Emita a lista de passageiros de viagens concluídas.</p>
        </div>
