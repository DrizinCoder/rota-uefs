...
function SucessoScreen() {
  ...
  return (
    <div className="min-h-screen w-full bg-[#f0f4f8] relative overflow-hidden flex items-center justify-center p-6">
      <DotPattern
        radialFade="edges"
        width={18}
        height={18}
      ...
      />
      <div className="relative z-10 w-full max-w-[420px] flex flex-col items-center text-center bg-white rounded-2xl shadow-sm border border-slate-100 p-8">
        <div className="bg-amber-50 rounded-full p-5 mb-6">
          <Clock className="h-10 w-10 text-amber-500" />
        </div>
        <h1 className="text-2xl font-extrabold text-[#103173] mb-2">Cadastro em análise</h1>
        <p className="text-sm text-[#73AABF] font-medium leading-relaxed mb-2">
          Seu cadastro foi recebido com sucesso.
        </p>
        <p className="text-sm text-[#73AABF] font-medium leading-relaxed mb-6">
        ...
        <span className="inline-flex items-center gap-1.5 text-xs font-bold text-amber-700 bg-amber-50 border border-amber-200 px-3 py-1.5 rounded-full mb-8">
          <Clock className="h-3 w-3" />
          Pendente de validação
        </span>
        <Button
          onClick={() => router.push("/")}
          className="w-full h-13 bg-[#103173] hover:bg-[#0d2660] text-white font-extrabold text-base rounded-xl transition-all duration-200 active:scale-[0.97] shadow-lg shadow-[#103173]/25"
        >
          Voltar para Home
        </Button>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-3">
                  ...
                  <div className="space-y-2">
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <Label htmlFor="employment" className="text-sm font-bold text-[#103173]/70 cursor-default select-none">
                          Vínculo
                        </Label>
                      </TooltipTrigger>
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      required
                      className="w-full h-12 px-3 bg-[#f0f4f8] border-transparent rounded-xl text-sm font-medium text-[#103173] focus:outline-none focus:ring-2 focus:ring-[#103173] focus:border-[#103173] focus:bg-white transition-all"
                    >
                ...
                <div className="space-y-2">
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <Label htmlFor="department" className="text-sm font-bold text-[#103173]/70 cursor-default select-none">
                        Departamento
                      </Label>
                    </TooltipTrigger>
                    <TooltipContent side="right">
                  ...
                  <div className="relative">
                    <BriefcaseBusiness className="absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 text-[#73AABF] pointer-events-none" />
                    <Input
                      id="department"
                      name="department"
                      placeholder="Ex: DTEC"
                          ...
                          return (
                            <div
                              ...
                              className={`flex items-center gap-1.5 text-xs transition-colors ${
                                ok ? "text-emerald-600 font-medium" : "text-[#73AABF]/70 font-medium"
                              }`}
                            >
                              <CheckCircle2
                                className={`h-3 w-3 shrink-0 ${
                                  ok ? "text-emerald-500" : "text-[#73AABF]/30"
                                }`}
                              />
                              {text}
                            </div>
